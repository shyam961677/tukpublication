                    ...
                    <div class="card-body table-responsive">
                        <table id="dataTable" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $key->module_name; ?></td>
                                    <td><?php echo $key->action; ?></td>
                                    <td>                                    
                                        <a href="<?php echo base_url('edit-modules/' . $key->id); ?>" class=" badge bg-warning" title="Edit"><i class="bi bi-pencil"></i></a>
                                        <a href="<?php echo base_url('delete-modules/' . $key->id); ?>" 
