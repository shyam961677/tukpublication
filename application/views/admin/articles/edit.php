               ...
               ?>
                <div class="col-md-12">
                    ...
                    <div class="card card-info card-outline mb-4">
                        ...
                        <form action="<?php echo base_url('articles-update'); ?>" method="post">
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        <label for="title" class="form-label">Title</label>
                                        <input type="text" class="form-control" id="title" name="title" value="<?php echo !empty($results->title)?$results->title:''; ?>" required/>
                                        <div class="text-danger"><?php echo form_error('title'); ?></div>
                                    </div> 

                                    <div class="col-md-12">
                                        <label for="content" class="form-label">Content</label>
                                        <textarea class="form-control" id="content" name="content" ><?php echo !empty($results->content)?$results->content:''; ?></textarea>
